...
-- SIG_MCX.txt
CoavinsFirearms.Include('MCX_Spear','Rifle_556')
CoavinsFirearms.Include('MCX_Spear_Melee','Rifle_556')
CoavinsFirearms.Include('MCX_Spear_HE','Rifle_556')
CoavinsFirearms.Include('MCX_Spear_INC','Rifle_556')
CoavinsFirearms.Include('MCX_Virtus','Rifle_556')
CoavinsFirearms.Include('MCX_Virtus_Melee','Rifle_556')
CoavinsFirearms.Include('MCX_Virtus_HE','Rifle_556')
CoavinsFirearms.Include('MCX_Virtus_INC','Rifle_556')
CoavinsFirearms.Include('MCX_VirtusPatrol','Rifle_556')
CoavinsFirearms.Include('MCX_VirtusPatrol_Melee','Rifle_556')
CoavinsFirearms.Include('MCX_VirtusPatrol_HE','Rifle_556')
CoavinsFirearms.Include('MCX_VirtusPatrol_INC','Rifle_556')
CoavinsFirearms.Include('MCX_Socom','Rifle_556')
CoavinsFirearms.Include('MCX_Socom_Melee','Rifle_556')
CoavinsFirearms.Include('MCX_Socom_HE','Rifle_556')
CoavinsFirearms.Include('MCX_Socom_INC','Rifle_556')
CoavinsFirearms.Include('JW3_TTI_MPX','Rifle_556')
